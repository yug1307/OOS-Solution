    ...
    <section
      ...
      <div className="relative z-10 max-w-8xl mx-auto space-y-12">
        ...
        <div className="text-center">
          ...
          <h2 className="roboto text-4xl sm:text-4xl font-semibold text-white leading-tight my-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((s, i) => (
            <div
              key={i} 
              className="group relative hover:bg-[#0a0f1e] backdrop-blur-sm border border-white/8 rounded-xl p-6 flex flex-col gap-4 cursor-pointer transition-all duration-300 hover:border-pink-400/40 hover:shadow-[0_0_24px_rgba(251,191,36,0.12)] hover:-translate-y-1"
            >
